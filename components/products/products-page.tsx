...
import { ArrowRight, BadgeCheck, Heart, ShoppingBag, Sparkles, Star } from 'lucide-react';
    ...
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_#fff8f1_0%,_#f5e6d7_40%,_#efe0cf_100%)]">
      ...
      <section className="mx-auto max-w-[1600px] px-4 py-10 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Everything in one place, laid out for a quick buying decision"
          description="The catalog uses static cards, clear price hierarchy, and direct links to the product detail pages."
        />
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {featuredProducts.map((product) => (
            <article
              key={product.slug}
              className="group overflow-hidden rounded-[2rem] border border-white/80 bg-white/82 shadow-[0_24px_60px_rgba(68,42,26,0.08)] backdrop-blur transition hover:-translate-y-1"
            >
              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <Heart className="mt-1 h-5 w-5 text-[#c18b62]" />
                </div>
